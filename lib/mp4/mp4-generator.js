...
var custom_durations = 0xFFFFFFFF;
...
mdhd = function (track) {
  ...
  if (track.samplerate) {
    ...
    track.duration = track.duration * (track.samplerate / 90000);
...
moov = function (tracks) {
  ...
  return box.apply(null, [types.moov, mvhd(custom_durations)].concat(boxes).concat(mvex(tracks)));
};
 ...
 */
trak = function (track) {
  track.duration = track.duration || custom_durations;
...
module.exports = {
  ...
  setDuration: function (duration) {
    if (duration) {
      custom_durations = duration * 90000;
    }
  },
